...
if ( ! current_user_can( 'manage_options' ) ) {
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'Reports', 'drope-delivery' ); ?></h1>
		<p><?php esc_html_e( 'Sorry, you do not have access to Reports. Contact the administrator.', 'drope-delivery' ); ?></p>
	</div>
	<?php
	return;
}
...
$url = esc_url( home_url( '/wp-admin/admin.php?page=drope-delivery-reports' ) );
...
<div class="wrap">
	...
	<section class="myd-custom-content-page">
		<div class="myd-admin-filter">
			<a class="myd-admin-filter__item <?php echo esc_attr( $filter_type === 'today' ? 'myd-admin-filter--active' : '' ); ?>" href="<?php echo esc_attr( $url . '&filter_type=today&from=' . $today ); ?>"><?php esc_html_e( 'Today', 'drope-delivery' ); ?></a>

			<a class="myd-admin-filter__item <?php echo esc_attr( $filter_type === '7' ? 'myd-admin-filter--active' : '' ); ?>" href="<?php echo esc_attr( $url . '&filter_type=7&from=' . $latest_7_days ); ?>"><?php esc_html_e( 'Latest 7 days', 'drope-delivery' ); ?></a>

			<a class="myd-admin-filter__item <?php echo esc_attr( $filter_type === '30' ? 'myd-admin-filter--active' : '' ); ?>" href="<?php echo esc_attr( $url . '&filter_type=30&from=' . $latest_30_days ); ?>"><?php esc_html_e( 'Latest 30 days', 'drope-delivery' ); ?></a>

			<div class="myd-admin-filter__range">
				<span><?php esc_html_e( 'From', 'drope-delivery' ); ?>:</span>
				...
				<span><?php esc_html_e( 'To', 'drope-delivery' ); ?>:</span>
				...
				<a class="button-primary" id="report-range-submit" data-from="<?php echo esc_attr( $filter_type === 'range' ? esc_attr( $from ) : '' ); ?>" data-to="<?php echo esc_attr( $filter_type === 'range' ? esc_attr( $to ) : '' ); ?>" data-url="<?php echo esc_attr( $url . '&filter_type=range&from={from}&to={to}'); ?>" href="#"><?php esc_html_e( 'Filter', 'drope-delivery' ); ?></a>
			</div>
		...
		<div class="myd-admin-cards myd-card-4columns">
			<div class="myd-admin-cards__item myd-cards--price">
				...
				<p class="myd-admin-cards__description"><?php esc_html_e( 'Total sales in this period', 'drope-delivery' ); ?></p>
			</div>
			...
			<div class="myd-admin-cards__item myd-cards--orders">
				...
				<p class="myd-admin-cards__description"><?php esc_html_e( 'Total orders in this period', 'drope-delivery' ); ?></p>
			</div>
			...
			<div class="myd-admin-cards__item myd-cards--purchased">
				...
				<p class="myd-admin-cards__description"><?php esc_html_e( 'Quantity of products sold', 'drope-delivery' ); ?></p>
			</div>
			...
			<div class="myd-admin-cards__item myd-cards--average">
				...
				<p class="myd-admin-cards__description"><?php esc_html_e( 'Average amount sales per day', 'drope-delivery' ); ?></p>
			</div>
		</div>

		<div class="myd-reports-charts">
			<div class="myd-reports__chart-wrapper myd-chart-30">
				<h3 style="text-align:center;"><?php echo __( 'Top 10 products', 'drope-delivery' ); ?></h3>
