...
<div id="tab-company-content" class="myd-tabs-content myd-tabs-content--active">
    <h2><?php esc_html_e( 'Company Settings', 'drope-delivery' );?></h2>
    <p><?php esc_html_e( 'In this section you can configure all the company settings.', 'drope-delivery' );?></p>

    <table class="form-table">
        <tbody>
    	    <tr>
        	    <th scope="row">
                    <label for="fdm-business-name"><?php esc_html_e( 'Company Name', 'drope-delivery' );?></label>
                </th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'The company name can be used in custom message or others parts of template/site.', 'drope-delivery' );?></p>
                </td>
            </tr>
        
            <tr>
        	    <th scope="row">
                    <label for="myd-business-whatsapp"><?php esc_html_e( 'WhatsApp', 'drope-delivery' );?></label>
                </th>
                <td>
                    <input name="myd-business-whatsapp" type="number" id="myd-business-whatsapp" value="<?php echo esc_attr( $whatsapp_phone ); ?>" class="regular-text">
                    <p class="description"><?php esc_html_e( 'This phone can be used in custom message or other parts of template/site.', 'drope-delivery' );?></p>
                </td>
            </tr>

            <tr>
        	    <th scope="row">
                    <label for="myd-business-mail"><?php esc_html_e( 'Email', 'drope-delivery' );?></label>
                </th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'This email can be used in custom message or other parts of template/site.', 'drope-delivery' );?></p>
                </td>
            </tr>
        
            <tr>
                <th scope="row">
                    <label for="fdm-business-country"><?php esc_html_e( 'Country', 'drope-delivery' );?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label><?php esc_html_e( 'Operation mode', 'drope-delivery' );?></label>
                </th>
                <td>
                    ...
                    <label for="myd-operation-mode-delivery"><?php esc_html_e( 'Delivery', 'drope-delivery' );?></label> <br>
                    ...
                    <label for="myd-operation-mode-take-away"><?php esc_html_e( 'Take Away', 'drope-delivery' );?></label> <br>
                    ...
                    <label for="myd-operation-mode-in-store"><?php esc_html_e( 'Digital Menu', 'drope-delivery' );?></label>
                </td>
            </tr>
            
            <tr>
                <th scope="row">
                    <label for="fdm-list-menu-categories"><?php esc_html_e( 'Menu Categories', 'drope-delivery' );?></label>
                </th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e( 'List all menu categories separated by comma (,). Like: cat1,cat2,cat3,cat4.', 'drope-delivery' );?></p>
                </td>
            </tr>
        </tbody>
    </table>
