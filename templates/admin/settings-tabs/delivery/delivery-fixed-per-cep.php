...
<div class="myd-delivery-type-content <?php echo esc_attr( $active );?>" id="myd-delivery-fixed-per-cep">
    <h2><?php esc_html_e( 'Fixed price (Limit by Zipcode range)', 'drope-delivery' ) ;?></h2>
    <p><?php esc_html_e( 'With this method you can define a fixed price for delivery and limit area by Zipcode range.', 'drope-delivery' ) ;?></p>

    <table class="form-table">
        <tbody>
    	    <tr>
        	    <th scope="row">
                    <label for="myd-delivery-mode-options[fixed-per-cep][price]"><?php esc_html_e( 'Price', 'drope-delivery' );?></label>
                </th>
                <td>
